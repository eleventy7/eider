...
public class AgronaWriter implements EiderCodeWriter
{
    ...
    public void generate(final ProcessingEnvironment pe, final List<PreprocessedEiderObject> forObjects)
    {
        ...
        for (final PreprocessedEiderObject object : forObjects)
        {
            ...
            generateFile(pe, object, state);
            if (object.buildRepository())
            {
                generateRepository(pe, object, state);
            }
        }
    ...
    {
        generateGenericBufferTypeReader(pe, packageName);
    }

    private void generateGenericBufferTypeReader(ProcessingEnvironment pe, final String packageName)
    {
                              ...
                              final AgronaWriterState state)
    {
        TypeSpec.Builder builder = TypeSpec.classBuilder(object.getName())
            ...
            .addFields(offsetsForFields(processingEnv, object.getPropertyList(), state))
