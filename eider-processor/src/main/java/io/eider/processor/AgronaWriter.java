...
public class AgronaWriter implements EiderCodeWriter
{
    ...
    @Override
    public void generate(final ProcessingEnvironment pe, final List<PreprosssedEiderObject> forObjects)
    {
        for (final PreprosssedEiderObject object : forObjects)
        {
            generateFile(pe, object);
        }
    }

    private void generateFile(final ProcessingEnvironment processingEnv, final PreprosssedEiderObject object)
    {
